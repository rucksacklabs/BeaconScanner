...
public class DeviceListActivity extends Activity {
    ...
    Map<String, String> devUUIDValues;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case HRPService.GATT_DEVICE_FOUND_MSG:
                ...
                final String uuid = data.getString(HRPService.EXTRA_UUID);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        addDevice(device, rssi, uuid);
                    }
                });
                break;
            default:
    ...
    private void populateList() {
        ...
        devUUIDValues = new HashMap<String, String>();
    ...
    private void addDevice(BluetoothDevice device, int rssi, String uuid) {
        ...
        devUUIDValues.put(device.getAddress(), uuid);
        if (!deviceFound) {
...
//            b.putString(BluetoothDevice.EXTRA_DEVICE, deviceList.get(position).getAddress());
            ...
            mService.connect(deviceList.get(position), false);
    ...
    class DeviceAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView tvuuid = (TextView) vg.findViewById(R.id.uuid);
            ...
            String uuidVal = devUUIDValues.get(device.getAddress());
            if(uuidVal != null) {
            	tvuuid.setText("UUID: " + uuidVal);
            }
